...
from models.data_base_collections import select_resource_collection
...
class Resource:
    ...
    def resource_read_specific_id(self, id_resource):
        ...
        filter = {"delete": 0}
        print(resource.find_one({"_id": id_object}, filter))

    def resource_update(self, id_resource, str_json):
        id_object = ObjectId(id_resource)
        resource.find_one_and_update({'_id': id_object}, {'$set': str_json})

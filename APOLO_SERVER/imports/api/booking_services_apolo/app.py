...
from queries import listPosts_resolver, getPost_resolver, \
                    listPosts_resolver_person, getPost_resolver_person
from mutations import create_post_resolver, update_post_resolver, \
                    delete_post_resolver, create_post_resolver_person, update_post_resolver_person
import requests

if __name__ == '__main__':
    url = 'http://127.0.0.1:5000/object_recognizer'
